...
import controlimplementasi.kelasteman;
 ...
 * @author microsoft
 */
public class randiclass extends javax.swing.JFrame {
List <model> record = new ArrayList<>();
    kontrolinterface randiservice;
    int row;
    
    /**
     * Creates new form randiclass
     */
    public randiclass() {
        initComponents();
        randiservice = new kelasteman();
        this.refresdata();
    }
...
String judul[]={"Id","Nama","Nohp","Email","Alamat"};
...
isitabel();
    ...
    private void jBTN_HAPUSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBTN_HAPUSActionPerformed
        ...
        // if(id.trim().equals("") && nama.trim().equals("")){
            ...
            //}else{
            try {
                randiservice.hapus(jTBL_Teman.getValueAt(row, 0).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(randiclass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new randiclass().setVisible(true);
            }
        });
    }
